...
ES6 introduced new ways to import modules. The old and new are described in the following
sections.
...
A module is a JavaScript file, but unlike in languages like Python, not everything in the
file is made available to scripts that reference the module. Instead, you explicitly define
what parts of the file to export.
...
You can also export an anonymous object full of random stuff (it shouldn't be actually 
_random_, but it needn't be as tightly related as a well-designed object). Here's an
example:
